...
def open_mesas():
    ...
    lb12 = Label(janela1, text = "Por favor, escolha a sua mesa:")
    lb12.grid(row = 0, column = 0)
    ...
    def bt1_click():
        ...
        if variavel == 1:
            ...
            janela2.geometry("220x50+300+300")
        else:
            lb11 = Label(janela2, text = "                                                                          Nao")
            lb11.grid(row = 0, column = 0)
            lb12 = Label(janela2, text = "                                                                          Voce quer usar esta mesa?")
    ...
    path_imagem = path_mesa + r"\Imagens\mesa.png"
    ...
    janela1.geometry("600x600+300+300")
    janela1.mainloop()