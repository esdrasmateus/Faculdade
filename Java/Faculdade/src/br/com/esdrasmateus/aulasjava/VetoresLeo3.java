    ...
    public static void main (String[] args){
        ...
        while (var1 != 0){
            ...
            if (var1 == 1) {
                ...
                System.out.println("O valor da média dos lucros é de: " + media);
            }
            soma = 0;
            System.out.print("\nDigite 0 para terminar o programa, 1 para mostrar os meses de ganhos, 2 para os meses de gastos e 3 para os meses de lucros, \n4 para mostrar a soma dos ganhos, 5 para a soma dos gastos, 6 para a soma dos lucros e 7 para a média dos lucros: ");
            var1 = s.nextInt();
